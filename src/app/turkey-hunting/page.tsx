      ...
      <section className="section-padding bg-bark-100">
        <div className="container-custom">
          ...
          <div className="flex justify-center">
            {seasons.map((season) => (
              <div key={season.name} className="bg-white rounded-lg p-8 shadow-md text-center max-w-md w-full">
                <div className="text-5xl mb-4">{season.icon}</div>
                <h3 className="text-2xl font-bold text-bark-800 mb-2">{season.name}</h3>
                <p className="text-lg text-pine-700 font-semibold mb-4">{season.dates}</p>
                <p className="text-bark-500 text-sm bg-bark-100 rounded-lg p-3">
                  {season.notes}
                </p>
              </div>
            ))}
      ...
      <section className="py-16 bg-pine-800 text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href={`tel:${phone.replace(/[^\d+]/g, '')}`} className="btn border-2 border-white text-white hover:bg-white hover:text-pine-700">
              Call {phone}
            </Link>
          </div>
        </div>
