    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-bark-800 mb-2">
                Camp House 1
              </h2>
              <p className="text-lg text-pine-700 font-medium mb-6">On Lake Scott</p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-pine-100 rounded-lg flex items-center justify-center mt-0.5">
                    <svg className="w-4 h-4 text-pine-700" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-semibold text-bark-800">Master Bedroom</p>
                    <p className="text-bark-500">Full private bath attached</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-pine-100 rounded-lg flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-bark-800">Front Room</p>
                    <p className="text-bark-500">2 twin beds</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-pine-100 rounded-lg flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-bark-800">Third Bedroom</p>
                    <p className="text-bark-500">2 queen beds</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-pine-100 rounded-lg flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-bark-800">Full Kitchen & Supplies</p>
                    <p className="text-bark-500">Cookware, utensils, outdoor cookers and grills</p>
                  </div>
                </div>
              </div>

              <div className="inline-flex items-center bg-pine-50 text-pine-800 rounded-lg px-4 py-2 font-medium">
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg text-pine-700 font-medium mb-6">On Lake Shannon</p>
              <p className="text-lg text-bark-500 mb-6">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-clay-100 rounded-lg flex items-center justify-center mt-0.5">
                    <svg className="w-4 h-4 text-clay-700" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-semibold text-bark-800">Twin Room</p>
                    <p className="text-bark-500">Comfortable twin beds</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-clay-100 rounded-lg flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-bark-800">2 King Rooms</p>
                    <p className="text-bark-500">King beds with shared bath between</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-clay-100 rounded-lg flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-bark-800">Loft</p>
                    <p className="text-bark-500">Queen bed with full private bath</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-clay-100 rounded-lg flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    <p className="font-semibold text-bark-800">Spacious Living Area</p>
                    <p className="text-bark-500">Fireplace, full kitchen, firewood furnished</p>
                  </div>
                </div>
              </div>

              <div className="inline-flex items-center bg-clay-50 text-clay-800 rounded-lg px-4 py-2 font-medium">
                <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
            ...
            <div className="relative aspect-video rounded-lg overflow-hidden shadow-lg bg-bark-200 order-1 lg:order-2">
              <Image
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {amenities.map((amenity) => (
              <div key={amenity.title} className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-pine-100 rounded-lg flex items-center justify-center">
                  <svg className="w-6 h-6 text-pine-700" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-bark-800 mb-2">{amenity.title}</h3>
                  <p className="text-bark-500">{amenity.description}</p>
                </div>
              </div>
            ))}
          </div>

          <div className="mt-8 max-w-xl mx-auto bg-amber-50 border border-amber-200 rounded-lg p-6">
      ...
      <section className="section-padding bg-bark-100">
        <div className="container-custom">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-bark-800 mb-4">$100 / Night</h2>
            <p className="text-lg text-bark-500 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/deer-hunting" className="text-pine-700 font-semibold hover:text-pine-800 inline-flex items-center">
                View Hunting Packages
                <svg className="w-4 h-4 ml-2" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                </svg>
              </Link>
              <Link href="/bass-fishing" className="text-pine-700 font-semibold hover:text-pine-800 inline-flex items-center">
      ...
      <section className="py-16 bg-clay-700 text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn bg-white text-clay-700 hover:bg-bark-100">
              Contact Us
            </Link>
            <Link href={`tel:${phone.replace(/[^\d+]/g, '')}`} className="btn border-2 border-white text-white hover:bg-white hover:text-clay-700">
              Call {phone}
            </Link>
          </div>
        </div>
