              ...
              >
                ...
                <div className={`${index % 2 === 1 ? 'md:order-1' : ''}`}>
                  <div className="flex gap-2 mb-4">
                    <span className="inline-block bg-pine-100 text-pine-700 px-3 py-1 rounded-full text-sm font-semibold">
                      {lake.size}
                    </span>
                    <span className="inline-block bg-pine-100 text-pine-700 px-3 py-1 rounded-full text-sm font-semibold">
                      {lake.species}
                  ...
                  <h3 className="text-3xl font-bold text-bark-800 mb-4">{lake.name}</h3>
                  <p className="text-bark-500 mb-6">{lake.description}</p>
                  <ul className="grid grid-cols-2 gap-2">
                    {lake.features.map((feature) => (
                      <li key={feature} className="flex items-center text-sm text-bark-600">
                        <svg className="w-4 h-4 mr-2 text-pine-600" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-8">
            <div className="bg-white rounded-lg p-6 shadow-md text-center">
              ...
              <h3 className="text-xl font-bold text-bark-800 mb-2">F1 Hybrid Bass</h3>
              <p className="text-sm text-pine-700 font-medium mb-2">Lake Shannon</p>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md text-center">
              <div className="text-4xl mb-3">🐟</div>
              <h3 className="text-xl font-bold text-bark-800 mb-2">Florida Strain</h3>
              <p className="text-sm text-pine-700 font-medium mb-2">Lake Scott</p>
              <p className="text-bark-500 text-sm">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md text-center">
              <div className="text-4xl mb-3">💪</div>
              <h3 className="text-xl font-bold text-bark-800 mb-2">Northern Strain</h3>
              <p className="text-sm text-pine-700 font-medium mb-2">Lake Patrick</p>
              <p className="text-bark-500 text-sm">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md max-w-2xl mx-auto text-center">
            <div className="text-4xl mb-3">🐠</div>
            <h3 className="text-xl font-bold text-bark-800 mb-2">Brim & Bluegill</h3>
            <p className="text-bark-500 text-sm">
